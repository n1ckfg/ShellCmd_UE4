...
ShellCmd_UE4RootPath=/home/nick/Documents/Unreal Projects/ShellCmd_UE4

gameProjectFile=/home/nick/Documents/Unreal Projects/ShellCmd_UE4/ShellCmd_UE4.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(ShellCmd_UE4Source.pri)
include(ShellCmd_UE4Header.pri)
include(ShellCmd_UE4Config.pri)
include(ShellCmd_UE4Includes.pri)
include(ShellCmd_UE4Defines.pri)
...
ShellCmd_UE4-Linux-Debug.commands = $$build ShellCmd_UE4 Linux Debug  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4-Linux-DebugGame.commands = $$build ShellCmd_UE4 Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4-Linux-Shipping.commands = $$build ShellCmd_UE4 Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4-Linux-Test.commands = $$build ShellCmd_UE4 Linux Test  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4.commands = $$build ShellCmd_UE4 Linux Development  -project="\"$$gameProjectFile\"" $$args

ShellCmd_UE4Editor-Linux-Debug.commands = $$build ShellCmd_UE4Editor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4Editor-Linux-DebugGame.commands = $$build ShellCmd_UE4Editor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4Editor-Linux-Shipping.commands = $$build ShellCmd_UE4Editor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4Editor-Linux-Test.commands = $$build ShellCmd_UE4Editor Linux Test  -project="\"$$gameProjectFile\"" $$args
ShellCmd_UE4Editor.commands = $$build ShellCmd_UE4Editor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	ShellCmd_UE4-Linux-Debug \
	ShellCmd_UE4-Linux-DebugGame \
	ShellCmd_UE4-Linux-Shipping \
	ShellCmd_UE4-Linux-Test \
	ShellCmd_UE4 \
	ShellCmd_UE4Editor-Linux-Debug \
	ShellCmd_UE4Editor-Linux-DebugGame \
	ShellCmd_UE4Editor-Linux-Shipping \
	ShellCmd_UE4Editor-Linux-Test \
	ShellCmd_UE4Editor \
