...
ShellCmd_UE4-Linux-Debug:
	 $(PROJECTBUILD) ShellCmd_UE4 Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4-Linux-DebugGame:
	 $(PROJECTBUILD) ShellCmd_UE4 Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4-Linux-Shipping:
	 $(PROJECTBUILD) ShellCmd_UE4 Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4-Linux-Test:
	 $(PROJECTBUILD) ShellCmd_UE4 Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4:
	 $(PROJECTBUILD) ShellCmd_UE4 Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4Editor-Linux-Debug:
	 $(PROJECTBUILD) ShellCmd_UE4Editor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4Editor-Linux-DebugGame:
	 $(PROJECTBUILD) ShellCmd_UE4Editor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4Editor-Linux-Shipping:
	 $(PROJECTBUILD) ShellCmd_UE4Editor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4Editor-Linux-Test:
	 $(PROJECTBUILD) ShellCmd_UE4Editor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ShellCmd_UE4Editor:
	 $(PROJECTBUILD) ShellCmd_UE4Editor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
